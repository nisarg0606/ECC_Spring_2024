...
hdfs_output="/assignment01/part2/output/$(date +%s)"
...
hadoop jar $HADOOP_HOME/share/hadoop/tools/lib/hadoop-streaming-3.3.6.jar \
    -file /home/hadoop/assignment01/part2/mapper.py \
    -mapper "/usr/bin/python3 /home/hadoop/assignment01/part2/mapper.py" \
    -file /home/hadoop/assignment01/part2/reducer.py \
    -reducer "/usr/bin/python3 /home/hadoop/assignment01/part2/reducer.py" \
    -input $hdfs_input \
