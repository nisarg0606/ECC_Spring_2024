...
hdfs_output="/assignment01/python/part1/output/$(date +%s)"
...
hadoop jar $HADOOP_HOME/share/hadoop/tools/lib/hadoop-streaming-3.3.6.jar \
    -file /home/hadoop/assignment01/python/part1/mapper2.py \
    -mapper "/usr/bin/python3 /home/hadoop/assignment01/python/part1/mapper2.py" \
    -file /home/hadoop/assignment01/python/part1/reducer2.py \
    -reducer "/usr/bin/python3 /home/hadoop/assignment01/python/part1/reducer2.py" \
    -input $hdfs_input \
    -output $hdfs_output
